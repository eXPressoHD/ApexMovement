...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh()
    {
        ...
        var originalObject = GetComponent<GameObject>();
    ...
    public class PartMesh
    {
        ...
        private ManageDestroyedParts _mdp;

        public PartMesh()
        {
            GameObject go = GameObject.Find("GlobalDestroyPartHandler");
            if(go != null)
            {
                _mdp = go.GetComponent<ManageDestroyedParts>();
            }
        }
